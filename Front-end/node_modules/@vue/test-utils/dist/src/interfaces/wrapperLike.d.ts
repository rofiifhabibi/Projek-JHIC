...
import type { DefinedComponent, FindAllComponentsSelector, FindComponentSelector, NameSelector, RefSelector } from '../types';
...
export default interface WrapperLike {
    ...
    findComponent<T extends (...args: any[]) => VNode>(selector: T): unknown extends ReturnType<T> ? DOMWrapper<Element> : '__ctx' extends keyof ReturnType<T> ? VueWrapper : DOMWrapper<Element>;
