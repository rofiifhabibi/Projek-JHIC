...
/**
 * @vue/test-utils v2.5.1
 * (c) 2026 Lachlan Miller
 * Released under the MIT License
 */

import * as Vue from 'vue';
import { nextTick, Fragment, setDevtoolsHook, proxyRefs, unref, TransitionGroup, Transition, BaseTransition, defineComponent, h, isRef, shallowReactive, reactive, ref, createApp, transformVNodeArgs, computed } from 'vue';
...
const sharedState = globalThis;
const config = (_a = sharedState[configKey]) !== null && _a !== void 0 ? _a : (sharedState[configKey] = createConfig());
...
class DOMWrapper extends BaseWrapper {
    ...
    getRootNodes() {
        var _a, _b;
        if (((_a = this.subTree) === null || _a === void 0 ? void 0 : _a.type) === Fragment &&
