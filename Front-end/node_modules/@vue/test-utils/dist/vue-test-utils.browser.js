...
var VueTestUtils = (function (exports, Vue, compilerDom, serverRenderer) {
    ...
    ***************************************************************************** */
    ...
    class DOMWrapper extends BaseWrapper {
        ...
        getRootNodes() {
            var _a, _b;
            if (((_a = this.subTree) === null || _a === void 0 ? void 0 : _a.type) === Vue.Fragment &&
        ...
        return new Proxy(vm, {
            get(vm, key, receiver) {
                if (vm.$.exposeProxy && key in vm.$.exposeProxy) {
                    ...
                    return Vue.unref(Reflect.get(vm.$.exposed, key, receiver));
                }
            ...
            if (this.componentVM.$.setupState.__isScriptSetup) {
                ...
                for (const [key, value] of Object.entries(data)) {
                    if (key in this.componentVM.$data) {
                        ...
                        // @ts-expect-error
                        mergeDeep(Vue.proxyRefs(this.componentVM.$.setupState), { [key]: value });
                    }
                }
            }
            else {
