		...
		create(context) {
			...
			*/
			function checkProgramForMaxLength(node) {
				...
				if (shouldIgnoreComments || maxCommentLength || shouldIgnoreTrailingComments) {
					if (templateBody) {
						if (templateBody.range[0] < programNode.range[0]) comments.push(...templateBody.comments, ...scriptComments);
