...
//#region lib/rules/singleline-html-element-content-newline.ts
...
var singleline_html_element_content_newline_default = {
	meta: {
		type: "layout",
		docs: {
	...
	create(context) {
		...
		const ignores = /* @__PURE__ */ new Set([...options.ignores, ...options.externalIgnores]);
		...
		function isIgnoredElement(node) {
			return ignores.has(node.name) || ignores.has(require_casing.pascalCase(node.rawName)) || ignores.has(require_casing.kebabCase(node.rawName));
		}
...
//#endregion
exports.default = singleline_html_element_content_newline_default;
